...
vol = h5read('loki.h5','/t0/channel0');
voldb = im2double(vol);
voldb = voldb*10000;
...
% for saving projections one can turn off 34 to 37 and turn on 39 and 40
     snpY = imshow(ShiftedNoisyProjectionscale),title('Shifted-Noisy Projections');
     saveas(snpY,sprintf('proj/SNP_Y_%d.png',angle)); 
